...
//320
        waterPlayRoot.getChildren().add(ok);
        waterPlayRoot.getChildren().add(done);
    ...
    private void checkMovements(){
        ...
        for(int i = 0; i < tempUser.getPlantHand ().size(); i++){
            try {
                ...
                waterPlayRoot.getChildren().add(buttonImageView);
                waterPlayRoot.getChildren().add(button);
        ...
        ok.setOnMouseClicked(event -> {
            waterPlayRoot.getChildren().add(target1);
            waterPlayRoot.getChildren().add(target2);
            waterPlayRoot.getChildren().add(target3);
            waterPlayRoot.getChildren().add(target4);
            waterPlayRoot.getChildren().add(target5);
        });
            ...
            for (int i = 0; i < 7; i++) {
                ...
                waterPlayRoot.getChildren().add(zombieImageView);
            }
        });
        ...
        target1.setOnDragDropped(event -> {
            ...
            if (db.hasString()) {
                if(Shop.makeNewPlantByName (button.getText()).getLife() * 10 <= coin){
                    ...
                    waterPlayRoot.getChildren().add(imageView);
